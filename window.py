...
from utils.general import (LOGGER, check_file, check_img_size, check_imshow, check_requirements, colorstr,
                           ...
                           is_ascii, is_chinese)
from utils.plots import Annotator, colors, save_one_box, RANK, check_font
...
class Annotator:
    ...
    def __init__(self, im, txt,line_width=None, font_size=None, font='Arial.ttf', pil=False, example='abc'):
    ...
    def box_label(self, box, label='', color=(128, 128, 128), txt_color=(255, 255, 255)):
        ...
        if self.pil or not is_ascii(label):
            ...
            if label:
                ...
                self.im = add.add_str(self.im, "test", box[0],box[1] - h if outside else box[1], (0, 0, 255, 0))
        else:  # cv2
            ...
            if label:
                ...
                self.im = add.add_str(self.im,self.txt,p1[0],p1[1]-150,(0,0,255,0))
...
class MainWindow(QTabWidget):
    ...
    ***界面初始化***
    ...
    def initUI(self):
        ...
        img_detection_title = QLabel("欢迎使用车牌检测系统!")
        img_detection_title.setFont(font_title)
        mid_img_widget = QWidget()
        mid_img_layout = QHBoxLayout()

        self.license_plate_number = QTextBrowser()
        ...
        mid_img_layout.addWidget(self.license_plate_number)
        ...
        about_title = QLabel('欢迎使用车牌系统')  # todo 修改欢迎词语
        ...
        label_super.setText("<a href='https://blog.csdn.net/ECHOSON'>欢迎使用</a>")
    ...
    ***检测图片***
    ...
    def detect_img(self):
        model = self.model
        self.license_plate_number.clear()
        # print("1")
        ...
        if source == "":
            ...
            for path, im, im0s, vid_cap, s in dataset:
                ...
                # pred = utils.general.apply_classifier(pred, classi fier_model, im, im0s)
                # Process predictions
                for i, det in enumerate(pred):  # per image
                    ...
                    annotator = Annotator(im0,"test",line_width=line_thickness, example=str(names))
                    if len(det):
                        ...
                        for *xyxy, conf, cls in reversed(det):
                            ...
                            annotator.txt = tmp
                            print(tmp)
                            self.license_plate_number.append(tmp)
                            # print("11")
                    ...
                    im0 = cv2.resize(im0, (0, 0), fx=resize_scale, fy=resize_scale)
                    #
                    # cv2.putText(im0, "nih3o",
                    #             (110,110), 2, 3, 2,
                    #             thickness=2, lineType=cv2.LINE_AA)
                    # im0 = add.add_str(im0,tmp,tem_list[0],tem_list[0],(0, 0, 255, 0))
